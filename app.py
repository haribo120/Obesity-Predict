...
if page == "How to Use the App":
    ...
    st.image("image/20240810_IRD001.webp", use_container_width=True)
    st.write("""
...
# Page 2: About Obesity
    ...
    with st.expander("📊 **Global and Regional Obesity Trends**", expanded=False):
        ...
        """, unsafe_allow_html=True)
        st.image("image/1aa0d26994667aa8697314d0e077c9c7b53f49ca-1240x874.webp", caption="Factors Influencing Obesity", use_container_width=True)
    ...
    with st.expander("🔑 **Key Factors Influencing Obesity**", expanded=False):
        ...
        """, unsafe_allow_html=True)
        st.image("image/Factors-contributing-to-pediatric-obesity-BED-binge-eating-disorder.png", caption="Factors Influencing Obesity", use_container_width=True)
    ...
    with st.expander("⚖️ **Why BMI Differs Between Men and Women**", expanded=False):
        ...
        """, unsafe_allow_html=True)
        st.image("image/bmi-for-men-and-women.webp", caption="BMI Difference between Men and Women", use_container_width=True)
    ...
    with st.expander("⚠️ **Health Risks Associated with Obesity**", expanded=False):
        ...
        """, unsafe_allow_html=True)
        st.image("image/369185864_614149610892096_6036807610600070169_n.jpg", caption="Health Risks of Obesity", use_container_width=True)
